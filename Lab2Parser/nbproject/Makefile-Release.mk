...
${TESTDIR}/tests/tests/testScanner.o: tests/tests/testScanner.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/tests/testScanner.o tests/tests/testScanner.cpp
...
${OBJECTDIR}/DatalogProgram_nomain.o: ${OBJECTDIR}/DatalogProgram.o DatalogProgram.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DatalogProgram_nomain.o DatalogProgram.cpp;\
	else  \
...
${OBJECTDIR}/Predicate_nomain.o: ${OBJECTDIR}/Predicate.o Predicate.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Predicate_nomain.o Predicate.cpp;\
	else  \
...
${OBJECTDIR}/Rule_nomain.o: ${OBJECTDIR}/Rule.o Rule.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Rule_nomain.o Rule.cpp;\
	else  \
...
${OBJECTDIR}/Scanner_nomain.o: ${OBJECTDIR}/Scanner.o Scanner.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Scanner_nomain.o Scanner.cpp;\
	else  \
